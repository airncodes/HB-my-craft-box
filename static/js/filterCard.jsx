...
function FilterdCardContainer() {
  const [fcards, setCards] = React.useState([]);

  function addCard() {

    const currentCards = [...fcards]; // makes a copy of cards. similar to doing currentCards = cards[:] in Python
  ...
  for (const currentCard of fcards) {
    linkCards.push(
...
ReactDOM.render(<FilterdCardContainer />, document.querySelector('#filtercontainer'));
